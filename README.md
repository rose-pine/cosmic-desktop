...
```bash
git clone https://github.com/rose-pine/cosmic-desktop.git
```
...
3. Select your desired variant from the [themes/](./themes/) directory and select `cosmic-settings.ron`

### COSMIC Terminal Color Scheme

1. Open COSMIC Terminal and navigate to `View -> Color schemes...`.
2. Click `Import` and browse to where you cloned this repository.
3. Select your desired variant from the [themes/](./themes/) directory and select `cosmic-term.ron`
...
- [Julia Mertz](https://github.com/juliamertz)
